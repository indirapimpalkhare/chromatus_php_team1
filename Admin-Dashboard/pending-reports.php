<?php
	...
	$common_msg ="";
     ...
     if(isset($_GET['accept_pr_id']))
	 {
		$accept_id = $_GET['accept_pr_id'];		
		
		$db->accept_pr_details_by_id($accept_id);
		$common_msg	=	"PR record accepted successfully.";
	 }
                                                            ...
                                                            <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
                                                                <thead>
                                                                    <tr>
																		...
																		<th style="width=30;text-align:center;">View/Edit</th>
																		<th style="width=30;text-align:center;">Accept</th>
                                                                ...
                                                                <tbody>
																 	<?php
																	       ...
																	       $get_pr	=	$db->fetch_pr_records_pending();
