<?php
    ...
    { 
        ...
        $news_category  =  $_POST['pr-category'];  
        if($flag==0)
        { 
                                ...
                                <div class="page-wrapper">
                                    <div class="page-header card">
                                        <div class="card-block">
                                            <h5 class="m-b-10">Manage Industries for Press Release</h5>
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                          <div class="col-sm-12">
                                                <div class="card">
                                                    ...
                                                    <h5>Add Industries for Press Release</h5>
                                        ...
                                        <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5> Press Release Industries</h5>
                                                        <span>You can Update and Delete your Press Release Industries Category here...</span>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-md-12"> 
                                                            ...
                                                            <table id="multi-colum-dt" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><a href="edit-pr-category.php?category-id=<?php echo $got_id; ?>" class="Edit_option"><i class="fa fa-pencil-square-o fa-2x"></i></a></td>
                                                                            
                                                                        <td><a href="manage-pr-category.php?del_category_id=<?php echo $got_id; ?>" class="delete_option"><i class="fa fa-trash-o fa-2x"></i></a></td>
                                                                      </tr>
                                                                    <?php
                                                                        $counter++;
                                                                        }
