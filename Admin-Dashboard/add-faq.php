<?php
    ...
    { 
        ...
        { 
            ...
            $common_msg =   "FAQ Added successfully.";
        }
                                ...
                                <div class="page-wrapper">
                                    <div class="page-header card">
                                        <div class="card-block">
                                            ...
                                            <p class="text-muted m-b-10">You can add your FAQ here..</p>
                                        </div>
                                    </div>
                                                                    ...
                                                                    <div class="j-row">
                                                                         ...
                                                                         <div class="j-unit">
                                                                            <div class="j-input">
                                                                                ...
                                                                                <span class="j-tooltip j-tooltip-right-top">Enter Question</span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="j-unit">
                                                                            <div class="j-input">
                                                                                <textarea name="answer" placeholder="Enter Answer Here" ></textarea>
                                                                                <span class="j-tooltip j-tooltip-right-top">Enter Answer</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
