...
<div class="fixed-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <a class="navbar-brand ml-5 mr-3" href="index.php"><img class="w-75" src="assets/images/logo.png"></a>
    <div class="container justify-content-center">
    <div class="collapse navbar-collapse" id="navbarstop">
      <div class="container">
  	    <ul class="navbar-nav mr-auto">
  	        <li class="nav-item text-primary ml-5 mr-5">
        ...
        <a href="#" class="text-white btn btn-primary mr-5">Register/Login</a>
  		</div>
    </div>
    </div>
  </nav>
