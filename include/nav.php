...
<div class="fixed-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <a class="navbar-brand ml-5" href="index.php"><img class="w-75" src="assets/images/logo.png"></a>
    <div class="container justify-content-center">
    <div class="collapse navbar-collapse" id="navbarstop">
      <div class="container">
  	    <ul class="navbar-nav mr-auto">
  	        <li class="nav-item text-primary ml-5">
  	           <a class="nav-link text-primary" href="mailto:info@chromatus.com"><i class="fa fa-envelope ">info@chromatus.com </i></a>
  	        </li>
  	        <li class="nav-item text-primary ml-5 pl-5">
  	        ...
  	        <div class="d-flex ml-5 pl-5">
	   		...
	   		<li class="nav-item ml-5 pl-5 mt-1">
             	<a href="#" class="text-white btn btn-primary ml-5">Register/Login</a>
	   		</li>
  		</ul>
  		</div>
